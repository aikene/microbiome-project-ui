...
def get_hmp_metadata():
    ...
    return hmp_metadata_df

hmp_metadata_df = get_hmp_metadata()
print(hmp_metadata_df.tail())

#
# EXAMPLE OUTPUT:
#
#                                             File Name     Data Category   
# 15  https://downloads.hmpdacc.org/ihmp/t2d/genome/...  abundance_matrix  \
# 16  https://downloads.hmpdacc.org/ihmp/t2d/genome/...  abundance_matrix   
# 17  https://downloads.hmpdacc.org/ihmp/t2d/genome/...  abundance_matrix   
# 18  https://downloads.hmpdacc.org/ihmp/t2d/genome/...  abundance_matrix   
# 19  https://downloads.hmpdacc.org/ihmp/t2d/genome/...  abundance_matrix   

#                       Data Format    Size Data Source  
# 15  Biological Observation Matrix  196 KB         HMP  
# 16  Biological Observation Matrix  304 KB         HMP  
# 17  Biological Observation Matrix  152 KB         HMP  
# 18  Biological Observation Matrix  268 KB         HMP  
# 19  Biological Observation Matrix  137 KB         HMP 
